...
export const STUDIO = {
  ...
  /** Quiet founder note — plain, no selling, no name, no résumé. */
  founderNote:
    "One founder builds everything here and uses it every day. If it isn't useful in real life, it doesn't ship.",
