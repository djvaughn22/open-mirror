...
const sections: Section[] = [
  {
    ...
    passages: [
      { label: "Exodus 14:13", code: "EXO", chapter: "14", verse: "13" },
      { label: "Deuteronomy 6:5", code: "DEU", chapter: "6", verse: "5" },
      { label: "Joshua 1:9", code: "JOS", chapter: "1", verse: "9" },
      { label: "Ruth 1:16", code: "RUT", chapter: "1", verse: "16" },
      { label: "1 Samuel 16:7", code: "1SA", chapter: "16", verse: "7" },
      { label: "Isaiah 6:8", code: "ISA", chapter: "6", verse: "8" },
      { label: "Micah 6:8", code: "MIC", chapter: "6", verse: "8" },
      { label: "Habakkuk 3:18", code: "HAB", chapter: "3", verse: "18" },
    ],
  },
  {
    title: "Psalms",
    ...
    passages: [
      { label: "Psalm 1:1", code: "PSA", chapter: "1", verse: "1" },
      { label: "Psalm 23:1", code: "PSA", chapter: "23", verse: "1" },
      { label: "Psalm 27:1", code: "PSA", chapter: "27", verse: "1" },
      { label: "Psalm 46:10", code: "PSA", chapter: "46", verse: "10" },
      { label: "Psalm 51:10", code: "PSA", chapter: "51", verse: "10" },
      { label: "Psalm 91:1", code: "PSA", chapter: "91", verse: "1" },
      { label: "Psalm 103:2", code: "PSA", chapter: "103", verse: "2" },
      { label: "Psalm 139:14", code: "PSA", chapter: "139", verse: "14" },
    ],
  },
  {
    title: "Proverbs",
    ...
    passages: [
      { label: "Proverbs 3:5", code: "PRO", chapter: "3", verse: "5" },
      { label: "Proverbs 4:23", code: "PRO", chapter: "4", verse: "23" },
      { label: "Proverbs 11:25", code: "PRO", chapter: "11", verse: "25" },
      { label: "Proverbs 15:1", code: "PRO", chapter: "15", verse: "1" },
      { label: "Proverbs 16:3", code: "PRO", chapter: "16", verse: "3" },
      { label: "Proverbs 18:10", code: "PRO", chapter: "18", verse: "10" },
      { label: "Proverbs 27:17", code: "PRO", chapter: "27", verse: "17" },
      { label: "Proverbs 31:8", code: "PRO", chapter: "31", verse: "8" },
    ],
  },
  {
    title: "Gospel",
    ...
    passages: [
      { label: "Matthew 5:3", code: "MAT", chapter: "5", verse: "3" },
      { label: "Matthew 6:9", code: "MAT", chapter: "6", verse: "9" },
      { label: "Matthew 28:19", code: "MAT", chapter: "28", verse: "19" },
      { label: "Mark 4:9", code: "MRK", chapter: "4", verse: "9" },
      { label: "Luke 10:27", code: "LUK", chapter: "10", verse: "27" },
      { label: "Luke 15:20", code: "LUK", chapter: "15", verse: "20" },
      { label: "John 1:14", code: "JHN", chapter: "1", verse: "14" },
      { label: "John 10:11", code: "JHN", chapter: "10", verse: "11" },
    ],
  },
  {
    title: "Epistles",
    ...
    passages: [
      { label: "Romans 8:1", code: "ROM", chapter: "8", verse: "1" },
      { label: "Romans 12:2", code: "ROM", chapter: "12", verse: "2" },
      { label: "1 Corinthians 13:4", code: "1CO", chapter: "13", verse: "4" },
      { label: "Galatians 5:22", code: "GAL", chapter: "5", verse: "22" },
      { label: "Ephesians 2:10", code: "EPH", chapter: "2", verse: "10" },
      { label: "Philippians 2:5", code: "PHP", chapter: "2", verse: "5" },
      { label: "Colossians 3:12", code: "COL", chapter: "3", verse: "12" },
      { label: "James 1:22", code: "JAS", chapter: "1", verse: "22" },
    ],
  },
  {
    title: "Genesis",
    ...
    passages: [
      { label: "Genesis 1:1", code: "GEN", chapter: "1", verse: "1" },
      { label: "Genesis 1:27", code: "GEN", chapter: "1", verse: "27" },
      { label: "Genesis 3:15", code: "GEN", chapter: "3", verse: "15" },
      { label: "Genesis 12:2", code: "GEN", chapter: "12", verse: "2" },
      { label: "Genesis 15:6", code: "GEN", chapter: "15", verse: "6" },
      { label: "Genesis 50:20", code: "GEN", chapter: "50", verse: "20" },
    ],
  },
  {
    title: "Revelation",
    ...
    passages: [
      { label: "Revelation 1:8", code: "REV", chapter: "1", verse: "8" },
      { label: "Revelation 3:20", code: "REV", chapter: "3", verse: "20" },
      { label: "Revelation 5:12", code: "REV", chapter: "5", verse: "12" },
      { label: "Revelation 7:17", code: "REV", chapter: "7", verse: "17" },
      { label: "Revelation 21:4", code: "REV", chapter: "21", verse: "4" },
      { label: "Revelation 22:13", code: "REV", chapter: "22", verse: "13" },
    ],
  },
];
