...
export default function CrossHeartPrayReflectPage() {
  ...
  async function beginReflection() {
    ...
    if (problem.length > 250) {
      setError("Please keep your entry to 250 characters or less.");
      return;
    }
    ...
    try {
      ...
      setError(
        err?.message || "Bible Explorer could not respond right now. Please try again."
      );
    } finally {
      setIsLoading(false);
    }
  ...
  Ask what you are praying through, learning, struggling with, or looking for
  in the Holy Bible. Explore Scripture, read in context, and pray your way
  through.
</p>
  ...
  * ACTS is a simple prayer guide: Adoration, Confession, Thanksgiving, and Supplication.
        ...
        <div className="mt-12 w-full rounded-3xl border border-zinc-800 bg-zinc-950 p-6 text-left shadow-2xl">
          ...
          <textarea
            ...
            placeholder="What are you praying through, learning, struggling with, or looking for in the Holy Bible?
...
A place to begin."
          ...
          >
            {isLoading ? "Exploring Scripture..." : "Holy Bible Explorer"}
          </button>
        ...
        {reflection && (
          <div className="mt-10 w-full rounded-3xl border border-zinc-800 bg-zinc-950 p-6 text-left">
            ...
            <div className="mt-6 rounded-3xl border border-yellow-400/20 bg-yellow-400/10 p-6 text-sm italic leading-7 text-yellow-100">
              <p>These passages may help you explore Scripture.</p>
              <p className="mt-3">
                Continue by exploring them directly in the Bible and reading the surrounding chapters for context.
              </p>
              <p className="mt-3">
                If these passages do not seem like a good fit, keep exploring Scripture or try another question. AI may not always identify the most relevant passages.
              </p>
            </div>
            ...
            <div className="mt-10 rounded-[2rem] border border-zinc-800 bg-gradient-to-b from-zinc-950 to-black p-7 text-left shadow-2xl">
              <div className="text-center">
                ...
                <p className="mx-auto mt-5 max-w-2xl text-sm italic leading-7 text-zinc-400">
                  ...
                  AI may miss the best match, but Scripture is always worth opening.
                </p>
              </div>
        ...
        <div className="mt-12 max-w-3xl text-center text-sm leading-7 text-zinc-500">
          Cross Heart Pray helps you explore Scripture and prayer. It is
