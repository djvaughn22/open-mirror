...
const LANES = [
  ...
  },
  {
    ...
    short: "Fri",
    lane: "Prophecy",
    summary: "Warnings, promises, hope.",
  },
  {
    key: "saturday",
    day: "Saturday",
